						...
						<Box>
							...
							<Box>
								...
								<Box style={{ marginTop: "20px" }}>
									<img
										src='https://images.unsplash.com/photo-1611095564985-89765398121e?ixid=MnwxMjA3fDF8MHxzZWFyY2h8MXx8YnVzaW5lc3N8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60'
						...
						>
							<TabPanel value={value} index={0} dir={theme.direction}>
								<Box>
									...
									<Typography paragraph>{courseDetails.description}</Typography>
									<Typography variant='h6' color='primary'>
										What will you learn?
									</Typography>
